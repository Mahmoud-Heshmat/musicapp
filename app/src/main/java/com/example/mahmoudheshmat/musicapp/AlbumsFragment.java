...
public class AlbumsFragment extends android.support.v4.app.Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sharedPreferences = getContext().getSharedPreferences(Constant.SORT_ALBUM, Context.MODE_PRIVATE);
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        data_list = get.getAllAalbums(getContext(), sort_type, sort_by);


        recyclerView.setLayoutManager(gridLayoutManager);
        adapter = new albumsAdapter(getContext(), data_list);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.menu_sort_by_az:
                ...
                data_list.clear();
                data_list = get_order.album_sortby(getContext(), Constant.ASC_SORT, Constant.MEDIASTORE_TITLE_ALBUM);
            ...
            case  R.id.menu_sort_by_za:
                ...
                data_list.clear();
                data_list = get_order.album_sortby(getContext(), Constant.DESC_SORT, Constant.MEDIASTORE_TITLE_ALBUM);
                adapter.notifyDatachanged(data_list);

                return true;
            case R.id.number_of_songs:

                data_list.clear();
                data_list = get_order.album_sortby(getContext(), Constant.ASC_SORT, Constant.MEDIASTORE_NUMBER_OF_SONGS);
                adapter.notifyDatachanged(data_list);
