...
public class artistSongsAdapter  extends RecyclerView.Adapter<artistSongsAdapter.ViewHolder> {
    ...
    public artistSongsAdapter(Context context, ArrayList<songs_item> items) {
    ...
    @Override
    public artistSongsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.raw_artistsongs, parent, false);
        return new artistSongsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(artistSongsAdapter.ViewHolder holder, final int position) {
    ...
    private void adapterListener(ViewHolder holder,final int position) {
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavigationUtils.artist_playingsongActivity(context, position);
            }
        });
    }
